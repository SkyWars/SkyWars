...
public class LeaveCommand extends SubCommand {
    ...
    private final String REMOVED_FROM_QUEUE = ColorList.REG + "You are no longer queued for the next game";
    private final String REMOVED_FROM_GAME = ColorList.REG + "You have fled the game";
    private final String NOT_IN = ColorList.ERR + "You are not queued for the next game.";
